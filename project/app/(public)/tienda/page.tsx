...
export default function TiendaPage() {
      ...
      prev
        .map((item) => {
          ...
          const nuevaCantidad = Math.min(
            Math.max(item.cantidad + delta, 0),
            item.producto.stock,
          );
  ...
  async function pagarConMercadoPago() {
    ...
    if (!parseCliente.success) {
      setErrorCheckout(
        parseCliente.error.issues[0]?.message ||
          "Completá correctamente tus datos.",
      );
      return;
    }
    ...
    try {
      ...
      setErrorCheckout(
        error instanceof Error
          ? error.message
          : "Ocurrió un error en el checkout.",
      );
      setProcesando(false);
    }
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-neutral-100 border-b border-zinc-200 py-12 px-6 lg:px-20">
        <div className="max-w-[1280px] mx-auto">
          ...
          <p className="text-zinc-600 text-base mt-2">
            Productos para tu mascota con retiro en La Falda.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-20 py-10">
        ...
        {cargando ? (
          <p className="text-zinc-600 py-16 text-center">
            Cargando catálogo...
          </p>
              ...
              return (
                ...
                >
                  <div className="aspect-video bg-neutral-100 flex items-center justify-center overflow-hidden">
                    {producto.imagen_url ? (
                      ...
                      <span className="text-3xl opacity-50">
                        {CATEGORIA_LABELS[producto.categoria]?.icono ?? "🛒"}
                      </span>
                    )}
                  </div>
                  <div className="p-4 flex-1 flex flex-col">
                    ...
                    <p className="text-zinc-600 text-base mt-2 flex-1">
      ...
      >
        <div className="h-full flex flex-col">
            ...
            {carrito.length === 0 ? (
              ...
              carrito.map((item) => (
                <div
                  ...
                  className="border border-zinc-200 rounded-2xl p-3 flex gap-3 items-center"
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-zinc-500 text-xs">
                      ${Number(item.producto.precio).toLocaleString("es-AR")} x{" "}
                      {item.cantidad}
                    </p>
                    <div className="mt-2 flex items-center gap-2">
                      <button
                        onClick={() => cambiarCantidad(item.producto.id, -1)}
                        className="px-2 rounded bg-neutral-100"
                      >
                        -
                      </button>
          ...
          <div className="p-4 border-t border-zinc-200 space-y-2">
            ...
            {errorCheckout && (
              <p className="text-red-400 text-xs">{errorCheckout}</p>
            )}
            <button
